...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.POST("/batch/archive", controller.ArchiveChannelBatch)
			channelRoute.POST("/batch/unarchive", controller.UnarchiveChannelBatch)
			channelRoute.POST("/batch", controller.DeleteChannelBatch)
			channelRoute.POST("/:id/archive", controller.ArchiveChannel)
			channelRoute.POST("/:id/unarchive", controller.UnarchiveChannel)
		...
		logRoute.GET("/:id/trace", middleware.AdminAuth(), controller.GetLogTrace)
