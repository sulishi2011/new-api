...
func InitOptionMap() {
	...
	common.OptionMap["AutomaticDisablePolicyGroups"] = operation_setting.AutomaticDisablePolicyGroupsToString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "AutomaticDisablePolicyGroups":
		err = operation_setting.AutomaticDisablePolicyGroupsFromString(value)
